...
out_name <- "annual_max_consecutive_days_tasmax_above_19712000_1in10_tasmax_3day"
    ...
    for(t in c(1:length(time_range))){
      ...
      for(yy in 1:length(threshold_years)){
        ...
        var1 <- ncvar_def("days", "days", list(londim, latdim), 1e32, 
                          paste0("annual maximum length of tasmax-heatwave exceeding the historical 1-10 heatwave in a ", thresh, " world"),
