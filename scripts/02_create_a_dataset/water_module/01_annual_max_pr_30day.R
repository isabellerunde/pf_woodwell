  ...
  for(m in 1:length(models)){ # loop through models
    ...
    for(t in c(1:length(time_range))){
      ...
      for(yy in 1:length(threshold_years)){
        ...
        system(command = paste0("cdo selmon,12 ", in_file_0, " /home/irunde/dec.nc") )
        system(command = paste0("cdo selmon,1 ", in_file_2, " /home/irunde/jan.nc") )
        
        system(command = paste0("cdo timmax -runsum,30 -mulc,86400 -cat /home/irunde/dec.nc ", in_file_1, "  /home/irunde/jan.nc ", out_file) )
